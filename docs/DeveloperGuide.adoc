...
* From just keeping track of contacts in *AB3*, *EasyTravel* is a major upgrade as it is a all-in-one application that allows the user to keep track of different aspects of planning for a trip. These aspects includes activity, transport bookings, packing list, etc.
