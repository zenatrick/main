...
MSS:
    1. User request to create a new trip.
    2. E.T. shows the list of trips.
    3. User adds a trip to the list.
    4. E.T. shows the updated list of trips.
Use case ends.
...
Extensions:
    ...
    3a. Incomplete details are given.
        3a1. E.T shows an error message.
        Use case resumes at step 3.
...
MSS:
    ...
    2. E.T. shows the list of things that needs to be completed
Use case ends.
----------------------------------------------------------------------------------------------------------------
[discrete]
=== Packing List
