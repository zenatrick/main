...
==== Add a new transportation booking: `addtransport`
...
==== View all items in the packing list: `listitem`
...
==== Find packing list items by keywords: `finditem`
...
==== Find packing list items by keywords that are categories: `finditemcategory`
