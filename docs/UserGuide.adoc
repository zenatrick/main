...
|*Add Packing List Item* : `additem name/ITEM quantity/QUANTITY category/CATEGORY`
|`additem name/underwear quantity/5 category/clothes`

|*Edit Packing List Item* : `edititem INDEX [name/NAME] [quantity/QUANTITY] [category/CATEGORY]`
|`edititem 1 name/shirt quantity/5 category/essentials`
...
|*Mark Packing List Item as unpacked* : `uncheckitem INDEX [MORE_INDEXES]...`
|`uncheckitem 1 4 7 13 16`
...
|*Add Preset* : `addpreset preset/PRESET_NAME`
|`addpreset beach`
