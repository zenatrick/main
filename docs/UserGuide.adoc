...
If you want to mark the first item in the packing list as packed, you can follow these instructions.

****
Marking the packing list item as packed:

1. Type `checkitem 1` into the command box into the __Command Box__.
2. Press `Enter` to execute.
...
1. The __Result Display__ will show a success message.
2. **E.T.** will switch to the __Packing List Tab__.
3. You can now see your checked item.
****
...
Assuming you want to mark the second item in the packing list as unpacked. You can follow these instructions.

****
Marking the packing list items as unpacked:

1. Type `uncheckitem 2` into the command box into the __Command Box__.
2. Press `Enter` to execute.
...
In the case where you want to sort the packing list by alphabetical order. You can follow these instructions.
