...
You can use this command to find activities by the name.

*Format:*

`findactivity NAME [MORE_NAMES]...`
...
This command finds items in your packing list according to the item names specified by you.
...
This command find items in your packing list according to the categories specified by you
