...
** Justification: The trip manager feature is one of the main features of Easy Travel. Without a trip, all the other features in Easy Travel will not be able to function.
...
* *Minor enhancement*:
I did the base code for the status feature, so that my team members could work from there.
