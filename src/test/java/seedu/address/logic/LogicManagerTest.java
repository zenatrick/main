...
//                new JsonAccommodationBookingStorage(temporaryFolder.resolve("transport.json"));
//        StorageManager storage = new StorageManager(addressBookStorage, transportBookingStorage,
//                fixedExpenseStorage, accommodationBookingStorage, userPrefsStorage);
//>>>>>>> Improve Code Quality
...
//=======
//                new PackingListManager(), new AccommodationBookingManager(), new UserPrefs());
//>>>>>>> Improve Code Quality
