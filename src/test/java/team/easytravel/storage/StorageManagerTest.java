...
//        JsonTransportBookingStorage transportBookingStorage = new JsonTransportBookingStorage(
//                getTempFilePath("tr"));
//        JsonFixedExpenseStorage fixedExpenseStorage = new JsonFixedExpenseStorage(
//                getTempFilePath("fe")
//        );
//<<<<<<< HEAD
//        JsonActivityManagerStorage activityStorage = new JsonActivityManagerStorage(
//                getTempFilePath("frre")
//        );
...
//                userPrefsStorage);
//=======
//        JsonAccommodationBookingStorage accommodationBookingStorage = new JsonAccommodationBookingStorage(
//                getTempFilePath("ac")
//        );
//        storageManager = new StorageManager(addressBookStorage,
//                transportBookingStorage, fixedExpenseStorage, accommodationBookingStorage, userPrefsStorage);
//>>>>>>> Improve Code Quality
//    }
//
